 ...
 * @author pkmud
 */
public class Q_Purchase extends javax.swing.JFrame {

    /**
     * Creates new form Q_Purchase
     */
    public Q_Purchase() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DATE", "BILL NO.", "DISTRIBUTOR", "BRAND", "MODEL", "ITEM CODE", "QUANTITY", "BUY PRICE", "SELL PRICE", "TOTAL"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Q_Purchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Q_Purchase().setVisible(true);
            }
        });
    }
