 ...
 * @author pkmud
 */
public class S_SalesBills extends javax.swing.JFrame {

    /**
     * Creates new form S_SalesBills
     */
    public S_SalesBills() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S_SalesBills.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new S_SalesBills().setVisible(true);
            }
        });
    }
